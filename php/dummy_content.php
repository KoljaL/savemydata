...
function random_text() {
    ...
    $lorem = ["lorem\n", "ipsum\n", "dolor\n", "sit\n", "amet\n", "consectetur\n", "adipiscing\n", "elit", "praesent", "interdum", "dictum", "mi\n", "non", "egestas\n", "nulla", "in", "lacus", "sed", "sapien", "placerat", "malesuada", "at", "erat", "etiam\n", "id", "velit", "finibus", "viverra", "maecenas", "mattis", "volutpat", "justo", "vitae", "vestibulum", "metus", "lobortis\n", "mauris\n", "luctus\n", "leo\n", "feugiat\n", "nibh\n", "tincidunt\n", "a", "integer", "facilisis\n", "lacinia", "ligula", "ac\n", "suspendisse", "eleifend", "nunc", "nec", "pulvinar", "quisque", "ut\n", "semper", "auctor", "tortor", "mollis", "est\n", "tempor", "scelerisque", "venenatis", "quis", "ultrices", "tellus", "nisi", "phasellus", "aliquam", "molestie", "purus", "convallis", "cursus", "ex", "massa\n", "fusce", "felis", "fringilla", "faucibus\n", "varius", "ante", "primis", "orci", "et", "posuere", "cubilia", "curae", "proin", "ultricies", "hendrerit", "ornare", "augue", "pharetra", "dapibus", "nullam", "sollicitudin", "euismod", "eget", "pretium", "vulputate", "urna", "arcu", "porttitor", "quam\n", "condimentum", "consequat", "tempus", "hac\n", "habitasse", "platea", "dictumst", "sagittis", "gravida", "eu", "commodo", "dui", "lectus", "vivamus", "libero", "vel", "maximus", "pellentesque", "efficitur\n", "class", "aptent", "taciti", "sociosqu", "ad\n", "litora", "torquent", "per", "conubia", "nostra", "inceptos", "himenaeos", "fermentum", "turpis", "donec", "magna", "porta", "enim", "curabitur", "odio", "rhoncus\n", "blandit", "potenti", "sodales", "accumsan", "congue\n", "neque", "duis", "bibendum", "laoreet", "elementum", "suscipit", "diam", "vehicula", "eros", "nam", "imperdiet", "sem", "ullamcorper", "dignissim", "risus", "aliquet", "habitant", "morbi", "tristique", "senectus", "netus", "fames", "nisl\n", "iaculis\n", "cras", "aenean"];
