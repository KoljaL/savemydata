(() => {
    ...
    const styles = /*CSS*/ `
        ...
        .vt-card { 
            color: var(--font_0);
            outline: 1px solid var(--border_0) ;
            border-radius: 4px; 
            background: var(--bg_3);
            display: flex;
        ...
        [data-theme="light-boxes"] .vt-card {
    ...
    function show(message = "My name is Toast, Vanilla Toast.", options, type) {
        options = {...window.Message.options, ...options }
