        ...
        <div class="row">
            ...
            <div class="input-group">
                ...
                <div class="range-group">
                    <input type="range" onChange="document.getElementById('rangeSliderLabel').innerText = this.value + ' K'" min="20" max="200" step="5" value="20">
        ...
        Functions.getAPIdata('login', loginForm)
            .then((res) => {
                ...
                if (res.code === 200) {
                    ...
                    document.getElementById('Form1FormError').innerHTML = res.message;
                }
            })
            .then(() => {
